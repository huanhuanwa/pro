...
const css_selector_for_html_1 = require("./css-selector-for-html");
const mockHtml = `<div class="test" id="mock">
<p>123<code></code>  </p>
</div><span></span>`;
describe('用于ts node的css选择器', () => {
    it('初始化', () => {
        let cssSelector = css_selector_for_html_1.createCssSelectorForHtml(mockHtml);
    ...
    it('~', () => {
        let cssSelctor = css_selector_for_html_1.createCssSelectorForHtml(mockHtml);

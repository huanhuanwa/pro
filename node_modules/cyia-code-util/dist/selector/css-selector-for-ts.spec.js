...
describe('用于ts node的css选择器', () => {
    ...
    it('传入字符串', () => {
        let cssSelctor = css_selector_for_ts_1.createCssSelectorForTs('let a=689');
    ...
    it('普通 node 做根节点', () => {
        ...
        let cssSelctor = css_selector_for_ts_1.createCssSelectorForTs(sourceFile);
        let nodeSelector = css_selector_for_ts_1.createCssSelectorForTs(cssSelctor.queryOne('ArrayLiteralExpression'));

...
import { ThyTransferSelectEvent, ThyTransferItem, InnerTransferDragEvent } from './transfer.interface';
...
export declare class ThyTransferListComponent implements OnInit, DoCheck {
    private root;
    private differs;
    lockItems: ThyTransferItem[];
    unlockItems: ThyTransferItem[];
    private _diff;
    private _lockDiff;
    private _unlockDiff;
    title: string;
    ...
    ngDoCheck(): void;
    lockListEnterPredicate: () => boolean;
    onSelectItem: (item: ThyTransferItem) => void;
    onUnselectItem: (item: ThyTransferItem) => void;
    drop(event: CdkDragDrop<ThyTransferItem[]>): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyTransferListComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyTransferListComponent, "thy-transfer-list", never, { "title": "title"; "items": "items"; "draggable": "draggable"; "canLock": "canLock"; "maxLock": "maxLock"; "template": "template"; "contentRef": "renderContentRef"; }, { "draggableUpdate": "draggableUpdate"; "selectItem": "selectItem"; "unselectItem": "unselectItem"; }, never, never>;
}

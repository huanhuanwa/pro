import { ChangeDetectorRef, EventEmitter, OnChanges, OnDestroy, SimpleChanges, StaticProvider } from '@angular/core';
...
export declare class ThyTimePickerComponent implements ControlValueAccessor, TimePickerComponentState, TimePickerControls, OnChanges, OnDestroy {
    ...
    ngOnDestroy(): void;
    private _renderTime;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyTimePickerComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyTimePickerComponent, "thy-time-picker", never, { "disabled": "disabled"; "hourStep": "hourStep"; "minuteStep": "minuteStep"; "secondsStep": "secondsStep"; "readonlyInput": "readonlyInput"; "mousewheel": "mousewheel"; "arrowKeys": "arrowKeys"; "showSpinners": "showSpinners"; "showMeridian": "showMeridian"; "showMinutes": "showMinutes"; "showSeconds": "showSeconds"; "meridians": "meridians"; "min": "min"; "max": "max"; "hoursPlaceholder": "hoursPlaceholder"; "minutesPlaceholder": "minutesPlaceholder"; "secondsPlaceholder": "secondsPlaceholder"; }, { "isValid": "isValid"; }, never, never>;
}

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/overlay'),require('@angular/cdk/portal'),require('@angular/common'),require('ngx-tethys/icon'),require('ngx-tethys/shared'),exports, require('@angular/core'), require('@angular/common'), require('ngx-tethys/shared'), require('ngx-tethys/core'), require('ngx-tethys/util'), require('rxjs'), require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('rxjs/operators'), require('@angular/animations'), require('ngx-tethys/icon')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/slide', ['@angular/core','@angular/cdk/overlay','@angular/cdk/portal','@angular/common','ngx-tethys/icon','ngx-tethys/shared','exports', '@angular/core', '@angular/common', 'ngx-tethys/shared', 'ngx-tethys/core', 'ngx-tethys/util', 'rxjs', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/overlay', '@angular/cdk/portal', 'rxjs/operators', '@angular/animations', 'ngx-tethys/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.cdk.overlay,global.ng.cdk.portal,global.ng.common,global.ngxTethys.icon,global.ngxTethys.shared,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].slide = {}), global.ng.core, global.ng.common, global['ngx-tethys'].shared, global['ngx-tethys'].core, global['ngx-tethys'].util, global.rxjs, global.ng.cdk.bidi, global.ng.cdk.coercion, global.ng.cdk.overlay, global.ng.cdk.portal, global.rxjs.operators, global.ng.animations, global['ngx-tethys'].icon));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports, core$1, common, shared, core, util, rxjs, bidi, coercion, overlay, portal, operators, animations, icon) { 
function ThySlideContainerComponent_ng_template_0_Template(rf, ctx) { }
var _c0 = ["*"];
var _c1 = ["thyHeader"];
var _c2 = ["thyHeaderOperate"];
...
function ThySlideHeaderComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ThySlideHeaderComponent_ng_template_2_Template_button_click_8_listener($event) { ɵngcc0.ɵɵrestoreView(_r11); var ctx_r10 = ɵngcc0.ɵɵnextContext(); return ctx_r10.closeModal($event); });
...
ThySlideContainerComponent.ɵfac = function ThySlideContainerComponent_Factory(t) { return new (t || ThySlideContainerComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT), ɵngcc0.ɵɵdirectiveInject(ThySlideConfig), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.ViewportRuler)); };
...
ThyInternalSlideRef.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ThyInternalSlideRef, factory: function (t) { return ThyInternalSlideRef.ɵfac(t); } });
...
ThySlideService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ThySlideService, factory: function (t) { return ThySlideService.ɵfac(t); } });
...
ThySlideModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThySlideModule_Factory(t) { return new (t || ThySlideModule)(); }, providers: [ThyInternalSlideRef, ThySlideService, THY_SLIDE_DEFAULT_CONFIG_PROVIDER], imports: [[common.CommonModule, shared.ThySharedModule, icon.ThyIconModule, overlay.OverlayModule, portal.PortalModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThySlideModule, { declarations: [ThySlideContainerComponent, ThySlideLayoutComponent, ThySlideHeaderComponent, ThySlideBodyComponent, ThySlideBodySectionComponent, ThySlideFooterComponent, ThyDrawerContainerDirective], imports: [ɵngcc3.CommonModule, ɵngcc5.ThySharedModule, ɵngcc4.ThyIconModule, ɵngcc1.OverlayModule, ɵngcc2.PortalModule], exports: [ThySlideLayoutComponent, ThySlideHeaderComponent, ThySlideBodyComponent, ThySlideBodySectionComponent, ThySlideFooterComponent, ThyDrawerContainerDirective] }); })();

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-tethys/core'),require('@angular/cdk/overlay'),require('ngx-tethys/shared'),require('@angular/common'),require('ngx-tethys/loading'),require('ngx-tethys/empty'),require('@angular/forms'),require('ngx-tethys/input'),require('ngx-tethys/icon'),require('ngx-tethys/label'),exports, require('ngx-tethys/empty'), require('ngx-tethys/icon'), require('ngx-tethys/input'), require('ngx-tethys/label'), require('ngx-tethys/loading'), require('ngx-tethys/shared'), require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('ngx-tethys/core'), require('ngx-tethys/util'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/a11y'), require('@angular/cdk/collections')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/select', ['@angular/core','ngx-tethys/core','@angular/cdk/overlay','ngx-tethys/shared','@angular/common','ngx-tethys/loading','ngx-tethys/empty','@angular/forms','ngx-tethys/input','ngx-tethys/icon','ngx-tethys/label','exports', 'ngx-tethys/empty', 'ngx-tethys/icon', 'ngx-tethys/input', 'ngx-tethys/label', 'ngx-tethys/loading', 'ngx-tethys/shared', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@angular/forms', 'ngx-tethys/core', 'ngx-tethys/util', 'rxjs', 'rxjs/operators', '@angular/cdk/a11y', '@angular/cdk/collections'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxTethys.core,global.ng.cdk.overlay,global.ngxTethys.shared,global.ng.common,global.ngxTethys.loading,global.ngxTethys.empty,global.ng.forms,global.ngxTethys.input,global.ngxTethys.icon,global.ngxTethys.label,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].select = {}), global['ngx-tethys'].empty, global['ngx-tethys'].icon, global['ngx-tethys'].input, global['ngx-tethys'].label, global['ngx-tethys'].loading, global['ngx-tethys'].shared, global.ng.cdk.overlay, global.ng.common, global.ng.core, global.ng.forms, global['ngx-tethys'].core, global['ngx-tethys'].util, global.rxjs, global.rxjs.operators, global.ng.cdk.a11y, global.ng.cdk.collections));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,ɵngcc8,ɵngcc9,ɵngcc10,exports, empty, icon, input, label, loading, shared, overlay, common, core, forms, core$1, util, rxjs, operators, a11y, collections) { 
var _c0 = ["selectedDisplay"];
var _c1 = ["trigger"];
var _c2 = ["panel"];
...
function ThySelectCustomComponent_ng_template_3_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("thyOnScrolled", function ThySelectCustomComponent_ng_template_3_ng_container_1_Template_div_thyOnScrolled_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r11); var ctx_r10 = ɵngcc0.ɵɵnextContext(2); return ctx_r10.onOptionsScrolled($event); });
...
function ThySelectCustomComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mousemove", function ThySelectCustomComponent_ng_template_3_Template_div_mousemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r16); var ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.dropDownMouseMove($event); });
...
function ThySelectComponent_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ThySelectComponent_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r2); var ctx_r1 = ɵngcc0.ɵɵnextContext(); return ctx_r1.clearSelectValue($event); });
...
ThySelectCustomComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ThySelectCustomComponent, selectors: [["thy-custom-select"]], contentQueries: function ThySelectCustomComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵcontentQuery(dirIndex, shared.ThySelectOptionGroupComponent, false);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThySelectCustomComponent, [{
        ...
        args: [{
            ...
            type: core.ViewChild,
            args: ['trigger', { read: core.ElementRef, static: true }]
        }], panel: [{
            type: core.ViewChild,
            args: ['panel', { read: core.ElementRef }]
        }], options: [{
            type: core.ContentChildren,
            args: [shared.ThyOptionComponent, { descendants: true }]
        }], optionGroups: [{
            type: core.ContentChildren,
            args: [shared.ThySelectOptionGroupComponent]
        }] }); })();
...
ThySelectModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThySelectModule_Factory(t) { return new (t || ThySelectModule)(); }, providers: [THY_SELECT_SCROLL_STRATEGY_PROVIDER], imports: [[
        ...
        ], ɵngcc3.ThyOptionModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThySelectModule, { declarations: [ThySelectComponent, ThySelectCustomComponent], imports: [ɵngcc4.CommonModule, ɵngcc7.FormsModule, ɵngcc8.ThyInputModule, ɵngcc10.ThyLabelModule, ɵngcc2.OverlayModule, ɵngcc5.ThyLoadingModule, ɵngcc3.ThySharedModule, ɵngcc9.ThyIconModule, ɵngcc6.ThyEmptyModule, ɵngcc3.ThySelectCommonModule, ɵngcc3.ThyOptionModule], exports: [ThySelectComponent, ThySelectCustomComponent, ɵngcc3.ThyOptionModule] }); })();

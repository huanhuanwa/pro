(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common/http'),require('ngx-tethys/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('ngx-tethys/core'), require('@angular/platform-browser'), require('rxjs'), require('@angular/common/http'), require('rxjs/operators'), require('ngx-tethys/util')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/icon', ['@angular/core','@angular/platform-browser','@angular/common/http','ngx-tethys/core','@angular/common','@angular/forms','exports', '@angular/core', '@angular/forms', '@angular/common', 'ngx-tethys/core', '@angular/platform-browser', 'rxjs', '@angular/common/http', 'rxjs/operators', 'ngx-tethys/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common.http,global.ngxTethys.core,global.ng.common,global.ng.forms,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].icon = {}), global.ng.core, global.ng.forms, global.ng.common, global['ngx-tethys'].core, global.ng.platformBrowser, global.rxjs, global.ng.common.http, global.rxjs.operators, global['ngx-tethys'].util));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports, i0, forms, i3, core, i1, rxjs, i2, operators, util) { 
var _c0 = ["*"];
'use strict';
...
ThyIconRegistry.ɵfac = function ThyIconRegistry_Factory(t) { return new (t || ThyIconRegistry)(ɵngcc0.ɵɵinject(ɵngcc1.DomSanitizer), ɵngcc0.ɵɵinject(ɵngcc2.HttpClient), ɵngcc0.ɵɵinject(i3.DOCUMENT)); };
...
ThyIconModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThyIconModule_Factory(t) { return new (t || ThyIconModule)(); }, imports: [[i3.CommonModule, forms.FormsModule, i2.HttpClientModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThyIconModule, { declarations: [ThyIconComponent], imports: [ɵngcc4.CommonModule, ɵngcc5.FormsModule, ɵngcc2.HttpClientModule], exports: [ThyIconComponent] }); })();

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-tethys/core'),require('@angular/common'),require('ngx-tethys/icon'),exports, require('@angular/common'), require('@angular/core'), require('ngx-tethys/icon'), require('ngx-tethys/core'), require('ngx-tethys/util')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/button', ['@angular/core','ngx-tethys/core','@angular/common','ngx-tethys/icon','exports', '@angular/common', '@angular/core', 'ngx-tethys/icon', 'ngx-tethys/core', 'ngx-tethys/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxTethys.core,global.ng.common,global.ngxTethys.icon,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].button = {}), global.ng.common, global.ng.core, global['ngx-tethys'].icon, global['ngx-tethys'].core, global['ngx-tethys'].util));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, common, core, icon, core$1, util) { 
var _c0 = ["*"];
var _c1 = ["thy-button-icon", ""];
...
ThyButtonGroupComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ThyButtonGroupComponent, selectors: [["thy-button-group"]], hostVars: 4, hostBindings: function ThyButtonGroupComponent_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, inputs: { thySize: "thySize", thyType: "thyType", thyClearMinWidth: "thyClearMinWidth" }, features: [ɵngcc0.ɵɵProvidersFeature([core$1.UpdateHostClassService])], ngContentSelectors: _c0, decls: 1, vars: 0, template: function ThyButtonGroupComponent_Template(rf, ctx) { if (rf & 1) {
...
ThyButtonModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThyButtonModule_Factory(t) { return new (t || ThyButtonModule)(); }, imports: [[common.CommonModule, icon.ThyIconModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThyButtonModule, { declarations: [ThyButtonComponent, ThyButtonIconComponent, ThyButtonGroupComponent], imports: [ɵngcc2.CommonModule, ɵngcc3.ThyIconModule], exports: [ThyButtonComponent, ThyButtonIconComponent, ThyButtonGroupComponent] }); })();

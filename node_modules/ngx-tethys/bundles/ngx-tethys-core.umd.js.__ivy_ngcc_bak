(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-tethys/util'), require('rxjs'), require('@angular/core'), require('@angular/common'), require('rxjs/operators'), require('@angular/animations'), require('@angular/cdk/overlay'), require('@angular/cdk/portal')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/core', ['exports', 'ngx-tethys/util', 'rxjs', '@angular/core', '@angular/common', 'rxjs/operators', '@angular/animations', '@angular/cdk/overlay', '@angular/cdk/portal'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].core = {}), global['ngx-tethys'].util, global.rxjs, global.ng.core, global.ng.common, global.rxjs.operators, global.ng.animations, global.ng.cdk.overlay, global.ng.cdk.portal));
}(this, (function (exports, util, rxjs, i0, i1, operators, animations, overlay, portal) { 'use strict';

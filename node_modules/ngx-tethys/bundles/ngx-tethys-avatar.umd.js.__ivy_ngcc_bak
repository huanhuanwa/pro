(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ngx-tethys/util'), require('ngx-tethys/core'), require('@angular/platform-browser'), require('ngx-tethys/icon')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/avatar', ['exports', '@angular/core', '@angular/common', 'ngx-tethys/util', 'ngx-tethys/core', '@angular/platform-browser', 'ngx-tethys/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].avatar = {}), global.ng.core, global.ng.common, global['ngx-tethys'].util, global['ngx-tethys'].core, global.ng.platformBrowser, global['ngx-tethys'].icon));
}(this, (function (exports, core, common, util, core$1, platformBrowser, icon) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ThyAvatarService = /** @class */ (function () {
        function ThyAvatarService() {
            this.ignoreAvatarSrcPaths = ["default.png"];
        }
        return ThyAvatarService;
    }());
    var ThyDefaultAvatarService = /** @class */ (function (_super) {
        __extends(ThyDefaultAvatarService, _super);
        function ThyDefaultAvatarService() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        ThyDefaultAvatarService.prototype.avatarSrcTransform = function (src, size) {
            return src;
        };
        ThyDefaultAvatarService.prototype.nameTransform = function (name) {
            return name;
        };
        return ThyDefaultAvatarService;
    }(ThyAvatarService));
    ThyDefaultAvatarService.decorators = [
        { type: core.Injectable }
    ];

    var sizeArray = [22, 24, 28, 32, 36, 48, 68, 110, 160];
    var DEFAULT_SIZE = 36;
    var thyAvatarSizeMap = {
        xxs: 22,
        xs: 24,
        sm: 32,
        md: 36,
    ...
    var ThyAvatarComponent = /** @class */ (function () {
        function ThyAvatarComponent(updateHostClassService, elementRef, thyAvatarService, domSanitizer) {
            ...
            this.thyError = new core.EventEmitter();
        ...
        Object.defineProperty(ThyAvatarComponent.prototype, "thyShowRemove", {
            set: function (value) {
                this._showRemove = util.coerceBooleanProperty(value);
            },
            enumerable: false,
            configurable: true
        });
        ...
        ThyAvatarComponent.prototype.findClosestSize = function (sizes, value) {
            var left = 0, right = sizes.length - 1, middle, result;
            while (left <= right) {
        ...
        ThyAvatarComponent.prototype._setAvatarName = function (value) {
            var name = this.thyAvatarService.nameTransform(value);
        ...
        ThyAvatarComponent.prototype.avatarImgError = function ($event) {
    ...
    ThyAvatarComponent.ctorParameters = function () { return [
    ...
    ThyAvatarComponent.propDecorators = {
        _isAvatar: [{ type: core.HostBinding, args: ['class.thy-avatar',] }],
        thyOnRemove: [{ type: core.Output }],
        thyError: [{ type: core.Output }],
        thyShowName: [{ type: core.Input }],
        thySrc: [{ type: core.Input }],
        thyName: [{ type: core.Input }],
        thySize: [{ type: core.Input }],
        thyShowRemove: [{ type: core.Input }],
        thyImgClass: [{ type: core.Input }],
    ...
    AvatarShortNamePipe.decorators = [
        { type: core.Pipe, args: [{ name: 'avatarShortName' },] }
    ];
    ...
    AvatarBgColorPipe.decorators = [
        { type: core.Pipe, args: [{ name: 'avatarBgColor' },] }
    ];
    ...
    AvatarSrcPipe.decorators = [
        { type: core.Pipe, args: [{ name: 'thyAvatarSrc' },] }
    ];
    AvatarSrcPipe.ctorParameters = function () { return [
        { type: ThyAvatarService }
    ]; };
    var AvatarPipes = [AvatarShortNamePipe, AvatarBgColorPipe, AvatarSrcPipe];
    ...
    exports.AvatarBgColorPipe = AvatarBgColorPipe;
    exports.AvatarPipes = AvatarPipes;
    exports.AvatarShortNamePipe = AvatarShortNamePipe;
    exports.AvatarSrcPipe = AvatarSrcPipe;
    exports.ThyAvatarComponent = ThyAvatarComponent;
    exports.ThyAvatarModule = ThyAvatarModule;
    exports.ThyAvatarService = ThyAvatarService;
    exports.ThyDefaultAvatarService = ThyDefaultAvatarService;
    exports.thyAvatarSizeMap = thyAvatarSizeMap;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-tethys-avatar.umd.js.map

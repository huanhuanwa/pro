(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-tethys/core'),require('@angular/common'),require('ngx-tethys/icon'),require('ngx-tethys/shared'),exports, require('ngx-tethys/icon'), require('ngx-tethys/shared'), require('@angular/common'), require('@angular/core'), require('ngx-tethys/core'), require('ngx-tethys/util')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/empty', ['@angular/core','ngx-tethys/core','@angular/common','ngx-tethys/icon','ngx-tethys/shared','exports', 'ngx-tethys/icon', 'ngx-tethys/shared', '@angular/common', '@angular/core', 'ngx-tethys/core', 'ngx-tethys/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxTethys.core,global.ng.common,global.ngxTethys.icon,global.ngxTethys.shared,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].empty = {}), global['ngx-tethys'].icon, global['ngx-tethys'].shared, global.ng.common, global.ng.core, global['ngx-tethys'].core, global['ngx-tethys'].util));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, icon, shared, common, core, core$1, util) { 
var _c0 = ["extra"];
...
var _c1 = function (a0, a1) { return { "thy-empty-text": a0, "thy-empty-text-with-extra": a1 }; };
'use strict';

    var ThyEmptyConfig = /** @class */ (function () {
        function ThyEmptyConfig() {
            this.noResultTranslateKey = 'common.tips.NO_RESULT';
            this.noResultWithTargetTranslateKey = 'common.tips.NO_RESULT_TARGET';
        }
ThyEmptyConfig.ɵfac = function ThyEmptyConfig_Factory(t) { return new (t || ThyEmptyConfig)(); };
ThyEmptyConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ThyEmptyConfig, factory: function (t) { return ThyEmptyConfig.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThyEmptyConfig, [{
        type: core.Injectable
    }], function () { return []; }, null); })();
        return ThyEmptyConfig;
    }());
    ...
    var ThyEmptyComponent = /** @class */ (function () {
        ...
        ThyEmptyComponent.prototype._calculatePosition = function () {
            ...
            var topAuto = util.coerceBooleanProperty(this.thyTopAuto);
            var marginTop = null;
            if (topAuto) {
                // 选择参考父容器居中
...
ThyEmptyComponent.ɵfac = function ThyEmptyComponent_Factory(t) { return new (t || ThyEmptyComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.ThyTranslate), ɵngcc0.ɵɵdirectiveInject(ThyEmptyConfig), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
ThyEmptyComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ThyEmptyComponent, selectors: [["thy-empty"]], contentQueries: function ThyEmptyComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc2.NgIf, ɵngcc2.NgClass, ɵngcc3.ThyIconComponent, ɵngcc2.NgTemplateOutlet], encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThyEmptyComponent, [{
    ...
    }], function () { return [{ type: ɵngcc1.ThyTranslate }, { type: ThyEmptyConfig }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }, { type: ɵngcc0.NgZone }]; }, { sizeClass: [{
    ...
    ThyEmptyComponent.ctorParameters = function () { return [
    ...
    ThyEmptyComponent.propDecorators = {
        sizeClass: [{ type: core.HostBinding, args: ['class',] }],
        thyMessage: [{ type: core.Input }],
        thyTranslationKey: [{ type: core.Input }],
        thyTranslationValues: [{ type: core.Input }],
        thyEntityName: [{ type: core.Input }],
        thyEntityNameTranslateKey: [{ type: core.Input }],
        thyIconName: [{ type: core.Input }],
        thySize: [{ type: core.Input }],
        thyMarginTop: [{ type: core.Input }],
        thyTopAuto: [{ type: core.Input }],
        thyContainer: [{ type: core.Input }],
        thyImageUrl: [{ type: core.Input }],
        thyDescription: [{ type: core.Input }],
        extraTemplateRef: [{ type: core.ContentChild, args: ['extra',] }]
    };

    var ThyEmptyModule = /** @class */ (function () {
        function ThyEmptyModule() {
        }
ThyEmptyModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ThyEmptyModule });
ThyEmptyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThyEmptyModule_Factory(t) { return new (t || ThyEmptyModule)(); }, providers: [ThyEmptyConfig], imports: [[common.CommonModule, shared.ThySharedModule, icon.ThyIconModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThyEmptyModule, { declarations: [ThyEmptyComponent], imports: [ɵngcc2.CommonModule, ɵngcc4.ThySharedModule, ɵngcc3.ThyIconModule], exports: [ThyEmptyComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThyEmptyModule, [{
        type: core.NgModule,
        args: [{
    ...
    exports.ThyEmptyComponent = ThyEmptyComponent;
    exports.ThyEmptyConfig = ThyEmptyConfig;
    exports.ThyEmptyModule = ThyEmptyModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-tethys-empty.umd.js.map
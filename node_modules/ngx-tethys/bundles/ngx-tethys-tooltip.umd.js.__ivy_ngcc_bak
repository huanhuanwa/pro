(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-tethys/tooltip', ['exports', '@angular/cdk/overlay', '@angular/cdk/a11y', '@angular/common', '@angular/core', '@angular/cdk/platform', 'rxjs/operators', 'ngx-tethys/util', '@angular/cdk/portal', 'rxjs', '@angular/animations', 'ngx-tethys/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].tooltip = {}), global.ng.cdk.overlay, global.ng.cdk.a11y, global.ng.common, global.ng.core, global.ng.cdk.platform, global.rxjs.operators, global['ngx-tethys'].util, global.ng.cdk.portal, global.rxjs, global.ng.animations, global['ngx-tethys'].core));
}(this, (function (exports, overlay, a11y, common, core, platform, operators, util, portal, rxjs, animations, core$1) { 'use strict';

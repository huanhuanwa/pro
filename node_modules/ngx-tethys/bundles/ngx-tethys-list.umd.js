(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-tethys/core'),require('@angular/common'),require('ngx-tethys/avatar'),require('ngx-tethys/shared'),exports, require('@angular/core'), require('@angular/common'), require('ngx-tethys/core'), require('ngx-tethys/shared'), require('ngx-tethys/util'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/a11y'), require('@angular/cdk/collections'), require('@angular/forms'), require('ngx-tethys/avatar')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/list', ['@angular/core','ngx-tethys/core','@angular/common','ngx-tethys/avatar','ngx-tethys/shared','exports', '@angular/core', '@angular/common', 'ngx-tethys/core', 'ngx-tethys/shared', 'ngx-tethys/util', 'rxjs', 'rxjs/operators', '@angular/cdk/a11y', '@angular/cdk/collections', '@angular/forms', 'ngx-tethys/avatar'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxTethys.core,global.ng.common,global.ngxTethys.avatar,global.ngxTethys.shared,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].list = {}), global.ng.core, global.ng.common, global['ngx-tethys'].core, global['ngx-tethys'].shared, global['ngx-tethys'].util, global.rxjs, global.rxjs.operators, global.ng.cdk.a11y, global.ng.cdk.collections, global.ng.forms, global['ngx-tethys'].avatar));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, core, common, core$1, shared, util, rxjs, operators, a11y, collections, forms, avatar) { 
var _c0 = ["*"];
var _c1 = ["metaAvatar"];
var _c2 = ["metaTitle"];
var _c3 = ["metaDescription"];
...
ThySelectionListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ThySelectionListComponent, selectors: [["thy-selection-list"], ["", "thy-selection-list", ""]], contentQueries: function ThySelectionListComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, shared.ThyListOptionComponent, false);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThySelectionListComponent, [{
        ...
        args: [{
            ...
            args: [shared.ThyListOptionComponent]
...
ThyListModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThyListModule_Factory(t) { return new (t || ThyListModule)(); }, imports: [[common.CommonModule, shared.ThyOptionModule, avatar.ThyAvatarModule], ɵngcc4.ThyOptionModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThyListModule, { declarations: [ThyListComponent, ThyListItemComponent, ThySelectionListComponent, ThyListItemMetaComponent], imports: [ɵngcc2.CommonModule, ɵngcc4.ThyOptionModule, ɵngcc3.ThyAvatarModule], exports: [ThyListComponent, ThyListItemComponent, ThySelectionListComponent, ThyListItemMetaComponent, ɵngcc4.ThyOptionModule] }); })();

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('@angular/cdk/coercion'), require('rxjs/operators'), require('@angular/cdk/keycodes')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/fullscreen', ['exports', '@angular/core', '@angular/common', 'rxjs', '@angular/cdk/coercion', 'rxjs/operators', '@angular/cdk/keycodes'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].fullscreen = {}), global.ng.core, global.ng.common, global.rxjs, global.ng.cdk.coercion, global.rxjs.operators, global.ng.cdk.keycodes));
}(this, (function (exports, i0, i1, rxjs, coercion, operators, keycodes) { 'use strict';
    ...
    ThyFullscreenModule.decorators = [

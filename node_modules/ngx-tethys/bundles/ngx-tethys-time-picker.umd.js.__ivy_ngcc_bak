(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('ngx-tethys/util'), require('ngx-tethys/store'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/time-picker', ['exports', '@angular/core', '@angular/forms', 'ngx-tethys/util', 'ngx-tethys/store', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys']['time-picker'] = {}), global.ng.core, global.ng.forms, global['ngx-tethys'].util, global['ngx-tethys'].store, global.ng.common));
}(this, (function (exports, core, forms, util, store, common) { 'use strict';

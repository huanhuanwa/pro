(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-tethys/core'),require('@angular/common'),require('ngx-tethys/shared'),require('ngx-tethys/icon'),exports, require('@angular/common'), require('@angular/core'), require('ngx-tethys/shared'), require('ngx-tethys/util'), require('ngx-tethys/core'), require('ngx-tethys/icon')) :
    typeof define === 'function' && define.amd ? define('ngx-tethys/statistic', ['@angular/core','ngx-tethys/core','@angular/common','ngx-tethys/shared','ngx-tethys/icon','exports', '@angular/common', '@angular/core', 'ngx-tethys/shared', 'ngx-tethys/util', 'ngx-tethys/core', 'ngx-tethys/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxTethys.core,global.ng.common,global.ngxTethys.shared,global.ngxTethys.icon,(global['ngx-tethys'] = global['ngx-tethys'] || {}, global['ngx-tethys'].statistic = {}), global.ng.common, global.ng.core, global['ngx-tethys'].shared, global['ngx-tethys'].util, global['ngx-tethys'].core, global['ngx-tethys'].icon));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, common, core, shared, util, core$1, icon) { 
var _c0 = ["prefix"];
var _c1 = ["value"];
var _c2 = ["title"];
var _c3 = ["suffix"];
...
ThyStatisticModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ThyStatisticModule });
ThyStatisticModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThyStatisticModule_Factory(t) { return new (t || ThyStatisticModule)(); }, providers: [], imports: [[common.CommonModule, shared.ThySharedModule, icon.ThyIconModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThyStatisticModule, { declarations: [ThyStatisticComponent], imports: [ɵngcc2.CommonModule, ɵngcc3.ThySharedModule, ɵngcc4.ThyIconModule], exports: [ThyStatisticComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThyStatisticModule, [{
        type: core.NgModule,
        args: [{

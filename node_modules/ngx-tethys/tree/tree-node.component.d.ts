...
import { ThyTreeNodeCheckState, ThyTreeEmitEvent } from './tree.class';
...
export declare class ThyTreeNodeComponent implements OnDestroy {
    ...
    private changeDragIconVisibility;
    nodeMouseEnter(event: Event): void;
    nodeMouseLeave(event: Event): void;
    clickNode(event: Event): void;
    clickNodeCheck(event: Event): void;
    expandNode(event: Event): void;
    isShowExpand(node: ThyTreeNode): any;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyTreeNodeComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyTreeNodeComponent, "thy-tree-node", never, { "thyAsync": "thyAsync"; "thyMultiple": "thyMultiple"; "thyDraggable": "thyDraggable"; "thyCheckable": "thyCheckable"; "node": "node"; "thyTitleTruncate": "thyTitleTruncate"; "templateRef": "templateRef"; "emptyChildrenTemplateRef": "emptyChildrenTemplateRef"; }, { "thyOnClick": "thyOnClick"; "thyOnExpandChange": "thyOnExpandChange"; "thyOnCheckboxChange": "thyOnCheckboxChange"; }, ["childrenTreeTemplateRef"], never>;
}

...
export declare class ThyAutocompleteConfig<TData = any> extends ThyAbstractOverlayConfig<TData> {
...
export declare const THY_AUTOCOMPLETE_DEFAULT_CONFIG: InjectionToken<ThyAutocompleteConfig<any>>;
export declare const THY_AUTOCOMPLETE_DEFAULT_CONFIG_PROVIDER: {
    provide: InjectionToken<ThyAutocompleteConfig<any>>;
    useValue: {
        hasBackdrop: boolean;
        panelClass: string;

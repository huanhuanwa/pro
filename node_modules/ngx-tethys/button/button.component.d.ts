...
export declare type ThyButtonType = 'primary' | 'secondary' | 'info' | 'outline-primary' | 'outline-default' | 'danger' | 'link' | 'link-secondary';
export declare class ThyButtonComponent implements OnInit {
    ...
    ngOnInit(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyButtonComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyButtonComponent, "[thy-button],[thyButton]", never, { "thyButton": "thyButton"; "thyType": "thyType"; "thyLoading": "thyLoading"; "thyLoadingText": "thyLoadingText"; "thySize": "thySize"; "thyIcon": "thyIcon"; "thySquare": "thySquare"; }, {}, never, ["*"]>;
}

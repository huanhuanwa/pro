...
export declare class ThyDragDirective<T = any> extends _MixinBase implements OnDestroy {
    ...
    dragRef: DragRef<T>;
    constructor(document: any, container: IThyDropContainerDirective, ngZone: NgZone, elementRef: ElementRef<HTMLElement>, service: ThyDragDropService<T>);
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyDragDirective<any>, [null, { optional: true; }, null, null, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<ThyDragDirective<any>, "thy-drag,[thyDrag]", never, { "dragData": "thyDrag"; "data": "thyDragData"; "disabled": "thyDragDisabled"; }, {}, never>;
}
export {};

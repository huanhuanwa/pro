...
export declare class ThyAnchorComponent implements OnDestroy, AfterViewInit, OnChanges {
    private document;
    private cdr;
    private platform;
    private zone;
    ...
    thyTarget: string | HTMLElement;
    readonly thyClick: EventEmitter<ThyAnchorLinkComponent>;
    readonly thyScroll: EventEmitter<ThyAnchorLinkComponent>;
    visible: boolean;
    wrapperStyle: {
        'max-height': string;
    };
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyAnchorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyAnchorComponent, "thy-anchor", ["thyAnchor"], { "thyAffix": "thyAffix"; "thyBounds": "thyBounds"; "thyOffsetTop": "thyOffsetTop"; "thyTarget": "thyTarget"; "thyContainer": "thyContainer"; }, { "thyClick": "thyClick"; "thyScroll": "thyScroll"; }, never, ["*"]>;
}

...
export declare class ThyMentionSuggestionsComponent<TItem = MentionDefaultDataItem> implements OnInit, OnDestroy {
    ...
    constructor(elementRef: ElementRef<HTMLElement>, ngZone: NgZone, popoverRef: ThyPopoverRef<any>);
    ngOnInit(): void;
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ThyMentionSuggestionsComponent<any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ThyMentionSuggestionsComponent<any>, "thy-mention-suggestions", never, {}, {}, never, never>;
}

//# sourceMappingURL=suggestions.component.d.ts.map